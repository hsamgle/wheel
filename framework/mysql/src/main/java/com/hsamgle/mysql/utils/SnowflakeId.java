...
public final class SnowflakeId {
	...
	private final long poch = 1514736000000L;
	...
	private static SnowflakeId worker;


	/**
	 *
	 * @方法功能：	TODO    通过单例方式来获取
	 * @编写时间：	2018/11/1 18:52
	 * @author：	黄先国 | huangxg@sondon.net
	 * * @param
	 * @return     SnowflakeId
	 */
	private static SnowflakeId getInstance(){
		if(worker==null){
			synchronized (SnowflakeId.class){
				if(worker==null){
					worker = new SnowflakeId(0,0);
				}
			}
		}
		return worker;
